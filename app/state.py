...
class State:
    ...
    def save(self):
        ...
        try:
            with os.fdopen(fd, 'w', encoding='utf-8') as f:
                json.dump({'entries': self.entries, 'tickets': self.tickets}, f, ensure_ascii=False, indent=2)
    ...
    def snapshot(self) -> dict:
        return {'entries': self.entries, 'tickets': self.tickets, 'total': self.entries + self.tickets}
